# app/business_logic/services/therapist_selector.py
...
class TherapistSelector:
    ...
    async def select_best_therapist(
        ...
        try:
            # 1. 创建当前学生的特征向量
            current_vector = await VectorUtils.create_student_feature_vector(basic_info.__dict__, portrait)
            ...
            # 选择综合得分最高的治疗师流派
            therapists_list = ["cbt", "psychodynamic", "humanistic"]
            best_therapy = random.choice(therapists_list)
